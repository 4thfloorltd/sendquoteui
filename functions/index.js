    ...
    try {
      invoiceId = await db.runTransaction(async (tx) => {
        ...
        tx.set(invoiceRef, {
          ...
          businessPhone: q.businessPhone || u.businessPhone || "",
          businessEmail: q.businessEmail ?? "",
          businessAddress: q.businessAddress ?? "",
          businessLogoUrl: q.businessLogoUrl || u.businessLogoUrl || "",
          businessLogoPath: q.businessLogoPath || u.businessLogoPath || "",
          bankName: u.bankName ?? "",
