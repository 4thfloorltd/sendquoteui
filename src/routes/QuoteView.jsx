...
const QuoteView = () => {
  ...
  if (error) {
    return (
      <Box sx={{ maxWidth: isSecuredQuoteView ? APP_PAGE_CONTENT_MAX_WIDTH : 500, mx: "auto", width: isSecuredQuoteView ? "100%" : undefined, boxSizing: "border-box", px: isSecuredQuoteView ? 0 : 2, py: 6, pt: isSecuredQuoteView ? 0 : 6 }}>
        {isSecuredQuoteView ? (
          <Button
            component={Link}
            to="/secured/quotes"
