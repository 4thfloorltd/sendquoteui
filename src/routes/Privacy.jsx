    ...
    <>
      ...
      <Box sx={{ maxWidth: 760, mx: "auto", px: { xs: 2, sm: 4 }, py: { xs: 4, md: 6 } }}>
        ...
        <Section title="1. Who we are">
          <P>
            SendQuote ("we", "us", "our") operates the website {DOMAIN} and provides quote and
            invoice management software for small businesses. For any privacy-related questions please
        ...
        <Section title="2. Data we collect">
          ...
          <Box component="ul" sx={{ pl: 3, mt: 0 }}>
            ...
            <Li><strong>Quote and invoice data</strong> - customer names, email addresses, line items, pricing, VAT or tax details, and any other information you enter when creating a quote or invoice. If you send or resend a document to a customer from the app, we use the customer email and content you provided to deliver that message; the customer does not need a SendQuote account.</Li>
            <Li><strong>Usage counters</strong> - counts used to enforce free plan limits (for example quotes created), associated with your account or email as described in the product.</Li>
        ...
        <Section title="3. How we use your data">
          <Box component="ul" sx={{ pl: 3, mt: 0 }}>
            ...
            <Li>To verify your email address at registration and when generating public quotes or invoices.</Li>
            <Li>To send transactional emails (verification codes; emails to you when a customer accepts or declines a quote; emails to your customers with a link to view or review an updated quote or invoice when you choose to send or resend from the app; and other service notifications as the product provides).</Li>
        ...
        <Section title="4. Data storage & processors">
          ...
          <Box component="ul" sx={{ pl: 3, mt: 0 }}>
            ...
            <Li><strong>SMTP email provider</strong> - used to send verification codes; customer messages for quotes and invoices (including the public link and your business details as shown on the document); owner notifications when a customer responds to a quote; and internal bug report alerts. Only the addresses and message content required for each email are transmitted.</Li>
            <Li><strong>Anthropic</strong> - optional AI-powered PDF extraction (Claude) for quote or invoice workflows. Only the content of PDFs you explicitly upload for parsing is sent; no other data is shared.</Li>
          </Box>
        </Section>
        ...
        <Section title="6. Data retention">
          <P>
            We retain your account, quote, and invoice data for as long as your account is active.
            If you delete your account, all associated data (quotes, invoices, profile, counters) is
